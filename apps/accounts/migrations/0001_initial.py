    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('USER', 'Usuário'), ('GUEST', 'Convidado')], default='USER', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_type', models.CharField(choices=[('RSA', 'RSA'), ('ECDSA', 'ECDSA'), ('ECDH', 'ECDH'), ('EdDSA', 'EdDSA')], max_length=10)),
